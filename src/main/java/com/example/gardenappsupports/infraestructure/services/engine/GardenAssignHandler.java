...
public class GardenAssignHandler implements IEntityAssignHandler {
    ...
    private List<DataRecord> activateGardens(List<DataRecord> dataRecords) {
    ...
    private List<DataRecord> deactivateGardens(List<DataRecord> dataRecords) {
        ArrayList<DataRecord> results = new ArrayList<>();
        for (DataRecord dataRecord : dataRecords) {
    ...
    private List<DataRecord> deleteGardens(List<DataRecord> dataRecords) {
        ArrayList<DataRecord> results = new ArrayList<>();
        for (DataRecord dataRecord : dataRecords) {
